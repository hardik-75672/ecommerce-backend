...
const { sendMail } = require("../service/commen");
   ...
   const mail=user.email;
    try {
      const subject = 'Your order has been placed 😄✅';
                        ...
                        <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                          <tr>
                            <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                              ...
                              <p>${order.selectedAddress.name}<br>${order.selectedAddress.city},${order.selectedAddress.state},${order.selectedAddress.pinCode}</p>
        ...
        if(mail){
console.log("p")
          const response = await sendMail({ to: mail, subject, html });
          res.json(response);
        }
    } catch (err) {
console.log("rr")
